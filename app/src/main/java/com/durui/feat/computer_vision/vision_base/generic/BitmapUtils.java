...
package com.durui.feat.computer_vision.vision_base.generic;
...
public class BitmapUtils {
    ...
    public static Bitmap getBitmap(ByteBuffer data, FrameMetadata metadata) {
        ...
        try {
            ...
            Timber.tag("VisionProcessorBase").e("Error: " + e.getMessage());
        }
        return null;
    }
    ...
    private static int getExifOrientationTag(ContentResolver resolver, Uri imageUri) {
        ...
        try (InputStream inputStream = resolver.openInputStream(imageUri)) {
            ...
            Timber.e(e, "failed to open file to read rotation meta data: " + imageUri);
            return 0;
        }
    ...
    //durui
    static final String parentPath = "/sdcard//DCIM/durui/";
    static public String store(Bitmap bitmap, String prefix) throws IOException {
        String fileName = prefix + "IMG_" + new SimpleDateFormat("yyyyMMdd_HHmmss").format(new Date()) + ".png";
