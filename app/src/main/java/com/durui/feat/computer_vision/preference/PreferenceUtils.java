...
package com.durui.feat.computer_vision.preference;
...
public class PreferenceUtils {
    ...
    public static PoseDetectorOptionsBase getPoseDetectorOptionsForLivePreview(Context context) {
        //durui 选择人体姿态关键点检测模型，0性能差但快，2性能好但慢，1介于两者之间
    ...
    public static boolean shouldPoseDetectionRunClassificationEnableTTS(Context context) {
        SharedPreferences sharedPreferences = PreferenceManager.getDefaultSharedPreferences(context);
        String prefKey = context.getString(R.string.pref_key_pose_detector_run_classification_tts);
        return sharedPreferences.getBoolean(prefKey, false);
    }
